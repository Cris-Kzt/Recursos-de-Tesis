...
<p align="center">
  ...
  <img src="docs/foto_prototipo_armado.jpg" alt="Foto del Prototipo" width="600"/>
</p>
...
*   `/codigo_esp32`: Código fuente para compilar y subir al microcontrolador ESP32 mediante el Arduino IDE.
*   `/modelos_3d`: Archivos en formato `.STL` listos para laminado e impresión 3D de los brazaletes ajustables.
*   `/docs`: Evidencia gráfica del funcionamiento, incluyendo comparativas del comportamiento de los sensores con y sin filtrado.
...
1.  **Impresión 3D:** Imprime los archivos ubicados en la carpeta `/modelos_3d`. Recomendado usar PLA o PETG con un 20% de relleno.
...
3.  **Software:** 
    *   Abre el archivo `main_teleoperacion.ino` en Arduino IDE.
    *   Asegúrate de tener instaladas las librerías `Wire.h`, `Adafruit_MPU6050` y `Adafruit_Sensor`.
    *   Sube el código a la placa.
4.  **Prueba:** Abre el Monitor Serie a 115200 baudios para observar el flujo de datos filtrados en tiempo real.

## 📊 Resultados del Filtrado

A continuación se muestra el impacto de la implementación matemática del Filtro de Kalman sobre la señal inercial pura del acelerómetro frente a movimientos bruscos:

<p align="center">
  <!-- Reemplaza el enlace por la gráfica que hicimos en Python -->
...
---
*Desarrollado como parte de proyecto de investigación/tesis.*
